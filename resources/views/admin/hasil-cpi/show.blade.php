    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="{{ route('admin.hasil-cpi.index') }}" class="btn btn-outline-secondary me-2">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <h6 class="fw-bold text-primary">Aksi yang Disarankan:</h6>
                            <div class="d-grid gap-2">
                                <a href="{{ route('admin.siswa.show', $hasil->siswa->id) }}"
                                    class="btn btn-outline-primary btn-sm">
                                    <i class="fas fa-user me-2"></i>Lihat Profil Lengkap Siswa
                                </a>
                                <a href="{{ route('admin.penilaian.create') }}?siswa_id={{ $hasil->siswa->id }}"
                                    class="btn btn-outline-success btn-sm">
                                    <i class="fas fa-plus me-2"></i>Tambah Penilaian Kriteria Lain
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-success">Tindak Lanjut:</h6>
                            <ul class="list-unstyled text-muted small">
                                @if ($hasil->persentase >= 80)
                                    <li><i class="fas fa-check text-success me-2"></i>Pertahankan pencapaian yang sudah
                                        baik</li>
                                    <li><i class="fas fa-check text-success me-2"></i>Berikan tantangan yang lebih tinggi
                                    </li>
                                    <li><i class="fas fa-check text-success me-2"></i>Jadikan contoh untuk siswa lain</li>
                                @elseif($hasil->persentase >= 70)
                                    <li><i class="fas fa-arrow-up text-info me-2"></i>Tingkatkan aspek yang masih kurang
                                    </li>
                                    <li><i class="fas fa-eye text-info me-2"></i>Pantau perkembangan secara berkala</li>
                                    <li><i class="fas fa-users text-info me-2"></i>Libatkan orang tua dalam pembelajaran
                                    </li>
                                @else
                                    <li><i class="fas fa-exclamation text-warning me-2"></i>Perlu program persiapan khusus
                                    </li>
                                    <li><i class="fas fa-clock text-warning me-2"></i>Evaluasi kembali setelah 1-2 bulan
                                    </li>
                                    <li><i class="fas fa-handshake text-warning me-2"></i>Konsultasi dengan psikolog anak
                                    </li>
                                @endif
                            </ul>
                        </div>
