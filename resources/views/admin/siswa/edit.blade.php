...
@section('title', 'Edit Siswa - SPK CPI')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold text-primary mb-1">Edit Siswa</h2>
                    <p class="text-muted mb-0">Edit data {{ $siswa->nama }}</p>
                </div>
                <div>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-user-edit text-primary me-2"></i>Form Edit Siswa</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('kode') is-invalid @enderror"
                                    id="kode" name="kode" value="{{ old('kode', $siswa->kode) }}" required>
                                @error('kode')
